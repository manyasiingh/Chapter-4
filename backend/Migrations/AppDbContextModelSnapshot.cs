...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.AboutContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("backend.Models.Book", b =>
                {
                    ...
                    b.Property<int?>("BookSaleEventId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("backend.Models.BookSaleEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("backend.Models.CouponStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("backend.Models.MonthlyQuizAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("backend.Models.QuizData", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("backend.Models.StartupPopupSettings", b =>
                {
                    ...
                    b.ToTable("StartupPopupSettings");
                });
            ...
            modelBuilder.Entity("backend.Models.IndianBook", b =>
                {
                    b.HasBaseType("backend.Models.Book");
                    ...
                    b.HasDiscriminator().HasValue("Indian");
                });
            ...
            modelBuilder.Entity("backend.Models.Book", b =>
                {
                    b.HasOne("backend.Models.BookSaleEvent", null)
                        .WithMany("Books")
                        .HasForeignKey("BookSaleEventId");
                });
            ...
            modelBuilder.Entity("backend.Models.CouponStock", b =>
                {
                    b.HasOne("backend.Models.Coupon", "Coupon")
                        .WithOne("Stock")
                        .HasForeignKey("backend.Models.CouponStock", "CouponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
